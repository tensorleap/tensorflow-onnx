...
class Tensor(object):
    ...
    def Quantization(self):
        ...
        if o != 0:
            ...
            from tf2onnxnightly.tflite.QuantizationParameters import QuantizationParameters
    ...
    def Sparsity(self):
        ...
        if o != 0:
            x = self._tab.Indirect(o + self._tab.Pos)
            from tf2onnxnightly.tflite.SparsityParameters import SparsityParameters
